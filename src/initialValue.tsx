...
export const initialValue = {
    ...
    mercariTaxonomy: (): InitialValue<IMercariTaxonomy> => ({ _id: new BSON.ObjectId(), fullname: '', hashTags: [], category: initialValue.mercariCategory() as any as IMercariCategory, subCategory: initialValue.mercariCategory() as any as IMercariCategory, subSubCategory: initialValue.mercariCategory() as any as IMercariCategory }),
