                ...
                <FormGroup row aria-labelledby=''>
                    {options.map(({ Element, text, key }) => (
                        <FormControlLabel
                            ...
                            control={<IconButton key={key} className='inline-flex object-contain p-0 rounded-none h-7 w-7 aria-selected:bg-magenta-500 aria-unselected:bg-sky-400' aria-selected={isSelected(key)} onClick={onClick(key)}>
