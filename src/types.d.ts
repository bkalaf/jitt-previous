...
import { ProductColors, Genders, ClosureTypes, FitTypes, LegStyles, GarmentLengths, LifestyleTypes, PocketTypes, RiseTypes, BootTypes, ShoeHeelTypes, ShoeWidths, StrapTypes, ToeStyles, SwimsuitBottomStyles, SwimsuitTopStyles, BacklineTypes, CollarTypes, CuffTypes, DressTypes, NeckTypes, SleeveTypes, SuitTypes, BookGenres, BookTypes, Languages, ESRBRatings, ConsoleTypes, MusicFormatTypes, MusicGenres, HeightMaps, BarcodeTypes, MovieGenres, MovieRatings, TVRatings, VideoFormatTypes, VideoTypes, ConnectorGenders, PowerTypes, BatteryTypes, AspectRatios, CellCarriers, DinnerwareTypes, ShapeTypes, ApplianceTypes, ClubTypes, FlexTypes, HandOrientations, IronTypes, ShaftTypes, WedgeTypes, MetalTypes, ItemConditions, ItemDispositions, Shippers, SleeveLengths, FlatwareTypes, CableTypes, DataConnectorTypes, PowerConnectorTypes, VideoConnectorTypes, Materials, ShippingSpeeds, PayorTypes, DriveType, MemoryType, MemoryFormFactor, HardDriveFormFactor, HardDriveConnectivity, HardDriveInterface, CompatibleDevices, CASLatency, Countries, AwardNames, HugoAwardCategories, EmmyAwardCategories, OscarAwardCategories, TonyAwardCategories, PulitzerPrizeAwardCategories, GrammyAwardCategories, NYTimesAwardCategories } from './schema/enums';
...
export type DetailTypes = 'apparel' | 'apparel/bottoms' | 'apparel/bottoms/legged' | 'apparel/bras' | 'apparel/bras/swimsuit' | 'apparel/footwear' | 'apparel/tops' | 'cables' | 'cables/data' | 'cables/power' | 'cables/video' | 'electronics' | 'electronics/visual' | 'electronics/visual/cell-phones' | 'electronics/computer-components' | 'electronics/computer-components/drives' | 'electronics/computer-components/ram' | 'electronics/computer-components/battery' | 'electronics/kitchen-appliances' | 'home-goods' | 'home-goods/decor' | 'home-goods/decor/wall-art' | 'home-goods/dinnerware' | 'home-goods/flatware' | 'home-goods/glassware' | 'media' | 'media/books' | 'media/music' | 'media/video-games' | 'media/videos' | 'media/videos/film' | 'media/videos/tv-series' | 'sporting-goods' | 'sporting-goods/golf' | 'sporting-goods/golf/clubs' | 'sporting-goods/tennis' | 'sporting-goods/tennis/rackets' | 'sporting-goods/bowling' | 'sporting-goods/bowling/balls' | 'general' | 'jewelry' | 'jewelry/precious-metal' | 'jewelry/costume' | 'toys' | 'toys/board-games';
...
export type IAwardHeader<T extends AwardNames> = {
    name: T;
    category: Opt<'hugo' extends T ? HugoAwardCategories : 'oscar' extends T ? OscarAwardCategories : 'emmy' extends T ? EmmyAwardCategories : 'tony' extends T ? TonyAwardCategories : 'pulitzer' extends T ? PulitzerPrizeAwardCategories : 'grammy' extends T ? GrammyAwardCategories : 'ny-times' extends T ? NYTimesAwardCategories : never>;
};
...
export type IDraft = {
    ...
    readonly getShipping: {
        carrier: Shippers;
        service: ShippingSpeeds;
        price: number;
        selector: string;
    };
    readonly getColor: Opt<{
        selector: string;
        name: string;
    }>;
    readonly getCondition: {
        selector: string;
        name: string;
    };
    ...
    readonly getSubCategory: {
        selector: string;
        name: string;
    };
    readonly getSubSubCategory: {
        selector: string;
        name: string;
    };
