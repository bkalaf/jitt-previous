...
export function deepEqual<T>(obj1?: T, obj2?: T): boolean {
    function inner(obj?: T) {
        ...
        if (typeof obj === 'object') {
            return is.array(obj)
                ...
                : is.realmObj(obj)
                ? 'Realm.Object'
                : is.linkingObjects(obj)
                ? 'Realm.LinkingObjects'
                : is.arrayBuffer(obj)
                ? 'data'
                : is.date(obj)
                ? 'date'
    ...
    switch (type1) {
        ...
        case 'objectId':
            return type2 === 'objectId' ? (obj1 as BSON.ObjectId).toHexString().localeCompare((obj2 as BSON.ObjectId).toHexString()) === 0 : type2 === 'string' ? (obj1 as BSON.ObjectId).toHexString().localeCompare(obj2 as string) === 0 : false;
        case 'date':
            return type2 === 'date' ? obj1 === obj2 : false;
        case 'uuid':
            return type2 === 'uuid' ? (obj1 as BSON.ObjectId).toHexString().localeCompare((obj2 as BSON.UUID).toHexString()) === 0 : type2 === 'string' ? (obj1 as BSON.UUID).toHexString().localeCompare(obj2 as string) === 0 : false;
        case 'binary':
        ...
        case 'Realm.Object':
            return (obj1 as Realm.Object).objectSchema().name === (obj2 as Realm.Object).objectSchema().name && Object.keys((obj1 as Realm.Object).objectSchema().properties).every((key) => deepEqual((obj1 as Realm.Object)[key as keyof Realm.Object], (obj2 as Realm.Object)[key as keyof Realm.Object]));
