...
export function handleSortAndFilter<T extends MRT_RowData>(sorted?: SortDescriptor[], filtered?: string, filteredArgs?: unknown[], match?: (x: any[]) => any[]) {
    ...
    const f3 = (r: Realm.Results<T>) => (match != null ? match(Array.from(r)) : Array.from(r));
