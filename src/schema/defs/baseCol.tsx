...
export function baseCol<T extends MRT_RowData, TValue>(helper: MRT_ColumnHelper<T>, name: keyof T & string, Cell: MRT_ColumnDef<T, TValue>['Cell'], Edit: MRT_ColumnDef<T, TValue>['Edit'], $header?: string, required = false, readonly = false, { multiple, ...options }: {
    max?: number | Date;
    min?: number | Date;
    maxLength?: number;
    minLength?: number;
