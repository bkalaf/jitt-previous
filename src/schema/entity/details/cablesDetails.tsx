...
export const cablesDetails: <T extends MRT_RowData>(...dependencies: IDependency<T, any>[]) => MRT_ColumnDef<T>[] = <T extends MRT_RowData>(...dependencies: IDependency<T, any>[]) =>
    [helper.enum(...dependencies)('cableType', 'Cable Type', { enumKey: 'cableTypes' }), groupCol(h, 'Cord Length', doubleMeasureColumns(h, 'lengthUnitOfMeasure'), 'cordLength', 'bg-orange-500', 'text-white')] as MRT_ColumnDef<T>[];
