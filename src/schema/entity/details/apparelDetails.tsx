...
export const apparelTops: MRT_ColumnDef<IProduct>[] = [
    ...
    addID('tops-womens-size', whenProperty('gender', 'womens', helper.enum('size', 'Womens Size', { options: getSizeOptions('womenLetter') }))),
    addID('tops-suit-size', helper.enum('size', 'Suit Size', { options: getSizeOptions('suitSizes') })),
