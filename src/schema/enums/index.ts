...
export type CollarTypes = "band-collar" | "button-down-collar" | "camp-collar" | "classic-collar" | "club-collar" | "collarless" | "cutaway-collar" | "hidden-button-down-collar" | "lapel-collar" | "mandarin-collar" | "point-collar" | "spread-collar" | "tab-collar" | "wingtip-collar";
...
export type CuffTypes = "angle-cut-cuff" | "barrel-cuff" | "double-cuff" | "french-cuff" | "ribbed-cuff" | "two-button-cuff" | "one-button-cuff" | "rounded-cuff" | "single-cuff" | "angle-cut cuff" | "angle-cut" | "barrel cuff" | "double cuff" | "french cuff" | "ribbed cuff" | "two-button cuff" | "one-button cuff" | "rounded cuff" | "round-cut cuff" | "round-cut-cuff" | "single cuff";

export type ConsoleTypes = "nes" | "snes" | "n64" | "gameboy" | "gameboy-advance" | "ds" | "ps1" | "ps2" | "ps3" | "ps4" | "ps5" | "wii" | "xbox";

export type DetailsTypes = "apparel-bottoms" | "apparel-bras" | "apparel-footwear" | "apparel-tops" | "apparel" | "cables-data" | "cables-power" | "cables-video" | "cables" | "cell-phones" | "electronics" | "general" | "home-goods-dinnerware" | "home-goods-flatware" | "home-goods" | "jewelry" | "kitchen-appliances" | "media-books" | "media-music" | "media-video-games" | "media-videos-film" | "media-videos-tv-series" | "media-videos" | "media" | "sporting-goods-golf-clubs" | "sporting-goods" | "toys";
...
export type Flags = "ALLOW_VALUES_ARRAYS" | "THROW_ON_GLOBAL_REALM" | "ALLOW_CLEAR_TEST_STATE";
...
export type LegStyles = "ankle-leg" | "baggy" | "bootcut" | "cropped" | "flared" | "skinny" | "straight-leg" | "tapered-leg" | "trouser-leg" | "wide-leg" | "baggy-leg" | "baggy leg" | "bootcut-leg" | "bootcut leg" | "cropped-leg" | "cropped leg" | "flared-leg" | "flared leg" | "skinny-leg" | "skinny leg" | "straight leg" | "tapered leg" | "trouser leg" | "wide leg";
...
export type NeckTypes = "boat-neck" | "choker-neck" | "collared-neck" | "cowl-neck" | "crew-neck" | "halter-neck" | "henley-neck" | "high-neck" | "hooded-neck" | "jewel-neck" | "mandarin-neck" | "mock-neck" | "notch-neck" | "off-shoulder-neck" | "one-shoulder-neck" | "sailor-collar-neck" | "scoop-neck" | "shawl-neck" | "square-neck" | "turtle-neck" | "v-neck" | "v neck" | "scoop neck" | "off-shoulder";

export type ProductColors = "silver" | "gold" | "yellow" | "brown" | "orange" | "pink" | "red" | "purple" | "blue" | "green" | "black" | "white" | "gray" | "beige" | "charcoal" | "grey" | "cream" | "eggshell" | "tan" | "burgundy" | "rose" | "crimson" | "scarlet" | "magenta" | "fuchsia" | "violet" | "cyan" | "aqua" | "teal" | "navy" | "denim" | "light-blue" | "lime" | "emerald" | "dark-green" | "forest-green" | "sea-green" | "amber" | "copper" | "goldenrod";
...
export type SleeveTypes = "balloon-sleeve" | "batwing-sleeve" | "bell-sleeve" | "bishop-sleeve" | "butterfly-sleeve" | "cap-sleeve" | "cape-sleeve" | "cold-shoulder-sleeve" | "cuff-sleeve" | "flutter-sleeve" | "kimono-sleeve" | "lantern-sleeve" | "leg-of-mutton-sleeve" | "puff-sleeve" | "raglan-sleeve" | "ruffle-sleeve" | "split-sleeve";
...
export type CellCarriers = "AT&T WirelessAT&T Wireless" | "Blue WirelessBlue Wireless" | "Boost MobileBoost Mobile" | "Consumer CellularConsumer Cellular" | "Cricket WirelessCricket Wireless" | "H2O WirelessH2O Wireless" | "Net10 WirelessNet10 Wireless" | "Simple MobileSimple Mobile" | "SprintSprint" | "Straight TalkStraight Talk" | "T-MobileT-Mobile" | "TingTing" | "Total WirelessTotal Wireless" | "TracFone WirelessTracFone Wireless" | "UnlockedUnlocked" | "UScellularUScellular" | "Verizon WirelessVerizon Wireless" | "Virgin MobileVirgin Mobile";
