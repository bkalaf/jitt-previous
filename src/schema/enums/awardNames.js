...
exports.awardCategories = exports.awardNames = void 0;
...
console.log(`export type AwardNames = ${Object.keys(exports.awardNames).map(surround_1.surroundQuotesIgnore).join(' | ')}`);
console.log(JSON.stringify(Object.entries(exports.awardNames).map(([k, v]) => ({
    key: k,
    text: v
})), null, '\t'));
exports.awardCategories = {
    'ny-times': {
        fiction: 'Fiction',
...
//     )
// );
//# sourceMappingURL=awardNames.js.map